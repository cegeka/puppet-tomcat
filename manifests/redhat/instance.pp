define tomcat::instance($tomcat_instance_dir, $tomcat_instance_name, $tomcat_instance_uid, $tomcat_instance_gid) {

  $real_tomcat_instance_dir = "$tomcat_instance_dir/$tomcat_instance_name"
